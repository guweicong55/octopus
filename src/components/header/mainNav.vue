      ...
      <nav>
        <ul class="nav_bar_wrapper">
          <li class="nav_bar_items">
            <router-link to="/home" active-class="nav_bar_link_active">
          ...
          <li class="nav_bar_items">
            <router-link to="/msg" active-class="nav_bar_link_active">
          ...
          <li class="nav_bar_items">
            <router-link to="/me" active-class="nav_bar_link_active">
