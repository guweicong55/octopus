<template>
  <div id="header_bar">
    <div class="search_wrapper" v-if="searchShow">
...
<script>
    ...
    export default {
      name: 'headBar',
      props: ['searchShow', 'backBtn', 'title', 'logo'],
      components: {
        searchComponent
      }
    }
