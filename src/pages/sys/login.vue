<template>
  <div id="login_container">
    ...
    <div class="field_wrapper">
      <div class="error_wrapper" v-show="errMsg">{{ errMsg }}</div>
      <input type="text" class="field" v-model="account" placeholder="用户名 或 邮箱" />
      <input type="password" class="field" v-model="password" placeholder="密码" />
      <span class="full_btn" @click="loginHandler">登 录</span>
      <p class="no_account">没有账号？<router-link to="/register">去注册>></router-link></p>
    </div>
